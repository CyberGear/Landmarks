...
//            JavaFile testPoint = JavaFile
//                    .builder(annotation.getAppId(), TypeSpec.classBuilder("TestPoint").build())
//                    .addFileComment("Generated by Landmarks generator")
//                    .build();
//
//            messager.printMessage(NOTE, "Landmarks generator: writing TestPoint");
//            testPoint.writeTo(filer);
//        } catch (Exception e) {
//            messager.printMessage(WARNING, "Landmarks generator: " + e.getMessage());
//            return true;
//        }
//        header();
//        return true;
